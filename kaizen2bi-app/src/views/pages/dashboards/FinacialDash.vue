    ...
    <div class="grid grid-cols-12 gap-8">
        <div class="col-span-12 lg:col-span-6 xl:col-span-3">
            <div class="card mb-0">
                ...
                <span class="text-primary font-medium">24 nuevas </span>
                <span class="text-muted-color">desde el útlimo acceso</span>
            </div>
        </div>
        <div class="col-span-12 lg:col-span-6 xl:col-span-3">
            <div class="card mb-0">
                <div class="flex justify-between mb-4">
                    <div>
                        <span class="block text-muted-color font-medium mb-4">Facturación</span>
                        <div class="text-surface-900 dark:text-surface-0 font-medium text-xl">$2.340.950</div>
                    </div>
                ...
                <span class="text-muted-color">que la semana pasada</span>
            </div>
        </div>
        <div class="col-span-12 lg:col-span-6 xl:col-span-3">
            <div class="card mb-0">
                ...
                <span class="text-muted-color">nuevos registrados</span>
            </div>
        </div>
        <div class="col-span-12 lg:col-span-6 xl:col-span-3">
            <div class="card mb-0">
                <div class="flex justify-between mb-4">
                    <div>
                        <span class="block text-muted-color font-medium mb-4">Alertas</span>
                        <div class="text-surface-900 dark:text-surface-0 font-medium text-xl">10 alertas sin revisar</div>
                    </div>
        ...
        <div class="col-span-12 xl:col-span-6">
            <div class="card">
                ...
                <DataTable :value="Products" :rows="5" :paginator="true" responsiveLayout="scroll">
                    ...
                    <Column field="price" header="Valor (ARS)" :sortable="true" style="width: 35%">
