...
export const ClientService = {
    ...
    getClientsWithOrdersSmall() {
        return Promise.resolve(this.getClientsWithOrdersData().slice(0, 10));
    },

    getClientsWithOrders() {
        return Promise.resolve(this.getClientsWithOrdersData());
    }
};
